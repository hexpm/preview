defmodule PreviewWeb.CoreComponents do
    ...
    <nav class="bg-grey-800 w-full font-sans">
      <div class="max-w-7xl mx-auto px-4 lg:px-8">
        <div class="flex items-center h-[72px] gap-8">
          ...
          <%= if @package do %>
            <.preview_breadcrumb package={@package} version={@version} />
          <% end %>
  ...
  @doc """
  Renders the package breadcrumb shown in the navbar when viewing a package.
  """
  attr :package, :string, required: true
  attr :version, :string, default: nil

  def preview_breadcrumb(assigns) do
    ~H"""
  ...
  defp footer_social_links(assigns) do
    ...
    <div class="flex gap-3 lg:mt-4">
      <.footer_social_link href="https://github.com/hexpm/preview" label="GitHub">
